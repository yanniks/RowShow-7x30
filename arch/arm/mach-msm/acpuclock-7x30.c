...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 1996800, PLL_2, 3, 0, 192000000, 1525, VDD_RAW(1525), &pll2_tbl[12]},
	{ 1, 2016000, PLL_2, 3, 0, 192000000, 1550, VDD_RAW(1550), &pll2_tbl[13]},
#else
        { 1, 1612800, PLL_2, 3, 0, 192000000, 1325, VDD_RAW(1325), &pll2_tbl[7]},
        ...
        { 1, 1996800, PLL_2, 3, 0, 192000000, 1525, VDD_RAW(1525), &pll2_tbl[8]},
        { 1, 2016000, PLL_2, 3, 0, 192000000, 1550, VDD_RAW(1550), &pll2_tbl[8]},
